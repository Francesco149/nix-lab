...
| `cold` | Cold storage and ZFS backup target with remote unlock support. Also runs a Plasma desktop driven over Moonlight, the torrent stack, and read-only SMB views of operator storage. |
